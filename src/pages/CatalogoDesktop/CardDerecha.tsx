...
const CardDerecha = ({precio,imagen,wsp}:card) => {
 ...
 <section className='bg-gradienteSecundario w-[350px] h-[300px] rounded-tr-[28px] rounded-br-[28px] relative top-0 z-[20] rounded-tl-[28px] rounded-bl-[28px]'>
 <img  className=' w-[330px] z-[21]' src={imagen} alt="" />
 </section>
 
 <img className='w-[210px] h-[210px] relative -top-[170px] left-[170px] z-[10] fill-current' src="/img/card.svg" alt="" />
